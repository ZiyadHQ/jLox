...
the project is written in VSC, it uses a simple .bat script to make it easier to build, but due to the way java runs it shouldn't be an issue as long as the
'.java' files are in the same directory.
